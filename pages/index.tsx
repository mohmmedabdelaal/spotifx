...
const  Home = ({artists})  =>{
    console.log(artists)
  return (
    <GridientLayout color='green' description="profile" title="Mohamed" subtitle="playing fifa" roundImage={true}  image="https://pbs.twimg.com/card_img/1632854840396201984/GNG07Rpx?format=jpg&name=medium">
      <Box>
          ...
          <Flex>
              {artists.map((artist) =>(
                  <Box paddingX="10px" width="20%" key={artist.id} >
                      ...
                      <Avatar size="xl" name={artist.name} src='https://bit.ly/sage-adebayo' />
                        </Center>
